...
#Método de RK4
    for i in range(1,n+1):
        ...
        k2 = function(*(y_values[i-1][0]+k1[0]*(h/2),y_values[i-1][1]+k1[1]*(h/2),y_values[i-1][2]+k1[2]*(h/2)))
        k3 = function(*(y_values[i-1][0]+k2[0]*(h/2),y_values[i-1][1]+k2[1]*(h/2),y_values[i-1][2]+k2[2]*(h/2)))
        k4 = function(*(y_values[i-1][0]+k3[0]*h,y_values[i-1][1]+k3[1]*h,y_values[i-1][2]+k3[2]*h,))
